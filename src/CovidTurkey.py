...
class covid_turkey:
    class vaccination:
        def get_first_dose_count(self, formatted = False):
            return functions.update_vaccination_data(data_arg="doz1asisayisi", formatted=formatted)
        ...
        def get_second_dose_count(self, formatted = False):
            return functions.update_vaccination_data(data_arg="doz2asisayisi", formatted=formatted)
        ...
        def get_third_dose_count(self, formatted = False):
            return functions.update_vaccination_data(data_arg="doz3asisayisi", formatted=formatted)
        ...
        def get_fourth_dose_count(self, formatted = False):
            return functions.update_vaccination_data(data_arg="doz4asisayisi", formatted=formatted)
        ...
        def get_total_dose_count(self, formatted = False):
            return functions.update_vaccination_data(data_arg="toplamasidozusayisi", formatted=formatted)

        def get_daily_dose_count(self, formatted = False):
            return functions.update_vaccination_data(data_arg="gunluksidozusayisi", formatted=formatted)
