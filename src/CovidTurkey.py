...
class covid_turkey:
    ...
    def get_first_dose_count(self):
        return self.update_vaccination_data(data_raw="doz1asisayisi")

    def get_first_dose_percent(self):
        return self.update_vaccination_data(data_raw="dozturkiyeortalamasi")

    def get_second_dose_count(self):
        return self.update_vaccination_data(data_raw="doz2asisayisi")

    def get_second_dose_percent(self):
        return self.update_vaccination_data(data_raw="doz2turkiyeortalamasi")

    def get_third_dose_count(self):
        return self.update_vaccination_data(data_raw="doz3asisayisi")

    def get_third_dose_percent(self):
        return self.update_vaccination_data(data_raw="doz3turkiyeortalamasi")

    def get_fourth_dose_count(self):
        return self.update_vaccination_data(data_raw="doz4asisayisi")

    def get_fourth_dose_percent(self):
        return self.update_vaccination_data(data_raw="doz4turkiyeortalamasi")

    def get_total_dose_count(self):
        return self.update_vaccination_data(data_raw="toplamasidozusayisi")

    def get_daily_dose_count(self):
        return self.update_vaccination_data(data_raw="gunluksidozusayisi")

    def get_last_update(self):
        return self.update_vaccination_data(data_raw="asidozuguncellemesaati")
